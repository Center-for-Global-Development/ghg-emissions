...
available for download from the working paper's page on cgdev.org. Use that if you want
to reproduce the committed outputs exactly; the download script fetches current data,
which for some sources is no longer the vintage this analysis used.
